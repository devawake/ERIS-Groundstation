...
cage -d chromium-browser --kiosk --noerrdialogs --disable-infobars --no-first-run --ozone-platform-hint=auto --enable-features=OverlayScrollbar http://localhost:5000 &
BROWSER_PID=$!
